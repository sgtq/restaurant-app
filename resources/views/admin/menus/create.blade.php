                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{ route('admin.menus.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="sm:col-span-6 pt-5">
                            ...
                            <div class="mt-1">
                                <input type="number" id="price" rows="3" name="price"
                                          class="shadow-sm focus:ring-indigo-500 appearance-none bg-white border py-2 px-3 text-base leading-normal transition duration-150 ease-in-out focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md @error('price') border-red-400 @enderror" />
                            </div>
                            @error('price')
                            <div class="text-sm text-red-400">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <select multiple id="categories" name="categories[]"
                                        class="form-multiselect block w-full mt-1 @error('categories') border-red-400 @enderror">
